      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center gap-4">
            <Link to="/login" className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-red-600 transition-colors">
              登录
            </Link>
          ...
          <div className="md:hidden py-4 border-t border-gray-100 animate-fade-in">
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col gap-2 mt-4 px-4">
                <Link to="/login" className="py-2.5 text-gray-700 font-medium hover:text-red-600 transition-colors text-center">
                  登录
                </Link>
